      ...
      <div className="navigation">
        <ul>
          <li>
            ...
            <label htmlFor="check-home" className="nav-label">
              Home
            </label>
          </li>
          <li>
            <input type="radio" name="navigations" id="check-about" />
            <label htmlFor="check-about" className="nav-label">
              About us
            </label>
          </li>
          <li>
            <input type="radio" name="navigations" id="check-news" />
            <label htmlFor="check-news" className="nav-label">
              News
            </label>
          </li>
          <li>
            <input type="radio" name="navigations" id="check-courses" />
            <label htmlFor="check-courses" className="nav-label">
              Courses
            </label>
          </li>{" "}
          <li>
            <input type="radio" name="navigations" id="check-research" />
            <label htmlFor="check-research" className="nav-label">
              Research
            </label>
          </li>
          <li>
            <input type="radio" name="navigations" id="check-contact" />
            <label htmlFor="check-contact" className="nav-label">
              Contact us
            </label>
          </li>
        </ul>
